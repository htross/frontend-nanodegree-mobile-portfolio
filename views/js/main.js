...
var resizePizzas = function(size) {
  ...
  /*
   * I refactored this method when I made changes to make resizing pizza faster.
   */
  function determineDx(oldsize, windowwidth, size) {
  ...
  function changePizzaSizes(size) {
    ...
    /*
     * These values are the same for all pizzas. Bringing the calculations outside of the loop
     * reduces time complexity of these calls from O(n) to O(1), where n is the number of pizzas
     */
    var oldwidth = document.querySelectorAll(".randomPizzaContainer")[0].offsetWidth;
    var windowwidth = document.querySelector("#randomPizzas").offsetWidth;
    var oldsize =  oldwidth / windowwidth;

    var dx = determineDx(oldsize, windowwidth, size);
...
/*
 * To get the page to run with a consistent frame rate of 60 fps, I moved the
 * document.body.scrollTop calculation outside of the loop. This was suggested by
 * chrome dev tools.
 */
